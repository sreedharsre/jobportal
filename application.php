...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <th>Select Job Title:</th>
            <th>
                <select>
                    <option>Software Professional Required</option>
                    <option>Software Professional Required abc</option>
                    <option>Software Professional Required def</option>
                    <option>Software Professional Required ghi</option>
                </select>
            </th>
            <th>
                <button>View</button>
