    ...
    <body>
        <div class="container">
			...
			<h3>
	            ...
	            <?php endif ?>
                        <form onsubmit="return validateForm()" action="static_emp_reg_server.php" method="post">
                            <table>
                                <tr>
                                    <td><label for="company-id">Company ID:</label></td>
                                    <td><input type="number" id="company-id" name="company-id"></td>
                                </tr>
                                <tr>
                                    <td><label for="company-name">Company Name:</label></td>
                                    <td><input type="text" id="company-name" name="company-name"></td>
                                </tr>
                                <tr>
                                    <td><label for="contact-person">Contact Person:</label></td>
                                    <td><input type="text" id="contact-person" name="contact-person"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td><label for="area-of-work">Area of Work:</label></td>
                                    <td><input type="text" id="area-of-work" name="area-of-work"></td>
                                </tr>
                                <tr>
