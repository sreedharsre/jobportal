    ...
    <div class="container">
        ...
        <div class="menu">
            ...
            <nav>
                ...
                <a href="manageseeker.php">Manage JobSeeker</a>
                <a href="manageemployeer.php">Manage Employer</a>
                <a href="news.php">News</a>
                <a href="feedback.php">Feedback</a>
                <a href="manageinterviewer.php">Manage Interviews</a>
        ...
        <div class="content">
            <div class="main">
                ...
                <p style="color: rgb(176, 176, 243); margin-top: 400px;">&copy;2014 jobportal.com</p>
            </div>
            <div class="sidebar">
                <h3>Welcome</h3>
                <p>Administrator</p>
