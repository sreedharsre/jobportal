            ...
            <div class="main">
                ...
                <h1><a href="#">Welcome To Control Panel</a></h1>
                   <div>
                       ...
                       <h3 style="  background-color: rgb(176, 176, 248);padding-bottom: 6px;padding-top: 6px;">Create News</h3>
 
                   <table>
                   <tr>
                   <td><label for="news">User Name:</label></td>
                   <td><input type="text" id="news" name="news"></td>
                   </tr>
                   <tr>
                     <td><label for="date">Password:</label></td>
                     <td><input type="text" id="news" name="news"></td>
                   </tr>
                   <tr>
                ...
                <div>
                    <h3 style="  background-color: rgb(176, 176, 248);padding-bottom: 6px;padding-top: 6px;">News List</h3>
                    <table>
