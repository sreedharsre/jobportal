            ...
            <div class="content">
                <div class="main">
                    <section>
                        ...
                        <h2><a href="#"><u>Latest News</u></a></h2>
                        <table  >
                            <tr>
                                <td></td>
                                <td >News</td>
                            ...
                            <tr>
                                <td style="border: 1px solid rgb(173, 173, 247);
                                    border-collapse: collapse;"><span style="font-size: 30px;color: rgb(250, 221, 73);">*</span></td>
                            ...
                            <tr>
                                <td style="border: 1px solid rgb(173, 173, 247);
                                    border-collapse: collapse;"><span style="font-size: 30px;color: rgb(250, 221, 73);">*</span></td>
                                <td>New vacancics will update after diwali </td>
                                <td>2013-09-21</td>
