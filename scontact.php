                ...
                <div class="main">
                    <section>
                        <table>
                            ...
                            <table style="border: 3px solid rgb(173, 173, 247);
                                   border-collapse: collapse;">
                                <tr style="border: 3px solid rgb(173, 173, 247);
                                    border-collapse: collapse;">
                                    <td style="border: 3px solid rgb(173, 173, 247);
                                        border-collapse: collapse;"><span style="font-size: 80px;color: rgb(250, 221, 73);">.</span></td>
                                    <td>Job portal<br>Near Kompally Road,<br>Hyderabad<br>
                                        Pincode:50082</td>
                                </tr>
                                <tr style="border: 3px solid rgb(173, 173, 247);
                                    border-collapse: collapse;">
                                    <td style="border: 3px solid rgb(173, 173, 247);
                                        border-collapse: collapse;"><span style="font-size: 80px; color: rgb(250, 221, 73);">.</span></td>
                                    <td style="border: 3px solid rgb(173, 173, 247);
                                        border-collapse: collapse; width: 500px;">Mobile: 9160752841</td>
                                </tr>
                                <tr style="border: 3px solid rgb(173, 173, 247);
                                    border-collapse: collapse;">
                                    <td style="border: 3px solid rgb(173, 173, 247);
                                        border-collapse: collapse;"><span style="font-size: 80px;color: rgb(250, 221, 73);">.</span></td>
                                    <td style="border: 3px solid rgb(173, 173, 247);
                                        border-collapse: collapse;">Email: bhanumanforthesociety@gmail.com</td>
                                </tr>
                                <tr style="border: 3px solid rgb(173, 173, 247);
                                    border-collapse: collapse;">
                                    <td style="border: 3px solid rgb(173, 173, 247);
                                        border-collapse: collapse;"><span style="font-size: 80px;color: rgb(250, 221, 73);">.</span></td>
                                    <td style="border: 3px solid rgb(173, 173, 247);
                                        border-collapse: collapse;">Website: Jobportal.com</td>
                                </tr>
                            </table>
                    </section>
                    <div class="n">
